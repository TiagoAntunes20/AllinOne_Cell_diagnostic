(function () {
  ...
  function startSession() {
    ...
    // Aponta direto pro módulo de teste de touch, levando o código
    // de sessão como parâmetro. Assume que /diagnostico/ e /touch-test/
    // ficam lado a lado na raiz do site publicado — ajuste o caminho
    // aqui se a estrutura final do repositório for diferente.
    const sessionUrl = `${window.location.origin}/touch.html?session=${code}`;
